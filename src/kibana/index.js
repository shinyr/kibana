...
var kibana = module.exports = modules.get('kibana', [
...
routes
  .otherwise({
    redirectTo: '/' + window.KIBANA_CONFIG.default_app_id
  });

// tell the modules util to add it's modules as requirements for kibana
modules.link(kibana);

KIBANA_PLUGINS.forEach(function (plugin) {
  require(plugin);
});
