define(function (require) {
  return function DataFactory(d3, Private) {
    ...
    var orderKeys = Private(require('vislib/components/zero_injection/ordered_x_keys'));
    var getLabels = Private(require('vislib/components/labels/labels'));
    var color = Private(require('vislib/components/color/color'));
