define(function (require) {
  return function ColumnLayoutFactory(d3, Private) {
    var chartSplit = Private(require('vislib/lib/layout/splits/column_chart/chart_split'));
    var yAxisSplit = Private(require('vislib/lib/layout/splits/column_chart/y_axis_split'));
    var xAxisSplit = Private(require('vislib/lib/layout/splits/column_chart/x_axis_split'));
    var chartTitleSplit = Private(require('vislib/lib/layout/splits/column_chart/chart_title_split'));
