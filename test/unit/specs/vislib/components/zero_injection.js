define(function (require) {
  ...
  describe('Vislib Zero Injection Module Test Suite', function () {
    ...
    describe('Zero Injection (main)', function () {
      ...
      beforeEach(function () {
        inject(function (Private) {
          injectZeros = Private(require('vislib/components/zero_injection/inject_zeros'));
    ...
    describe('Order X Values', function () {
      ...
      beforeEach(function () {
        inject(function (Private) {
          orderXValues = Private(require('vislib/components/zero_injection/ordered_x_keys'));
    ...
    describe('Unique Keys', function () {
      ...
      beforeEach(function () {
        inject(function (Private) {
          uniqueKeys = Private(require('vislib/components/zero_injection/uniq_keys'));
    ...
    describe('Flatten Data', function () {
      ...
      beforeEach(function () {
        inject(function (Private) {
          flattenData = Private(require('vislib/components/zero_injection/flatten_data'));
    ...
    describe('Zero Filled Array', function () {
      ...
      beforeEach(function () {
        inject(function (Private) {
          createZeroArray = Private(require('vislib/components/zero_injection/zero_filled_array'));
    ...
    describe('Zero Filled Data Array', function () {
      ...
      beforeEach(function () {
        inject(function (Private) {
          zeroFillArray = Private(require('vislib/components/zero_injection/zero_fill_data_array'));
          createZeroArray = Private(require('vislib/components/zero_injection/zero_filled_array'));
