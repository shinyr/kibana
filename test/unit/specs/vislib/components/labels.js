define(function (require) {
  ...
  describe('Vislib Labels Module Test Suite', function () {
    ...
    describe('Labels (main)', function () {
      ...
      beforeEach(function () {
        inject(function (d3, Private) {
          getLabels = Private(require('vislib/components/labels/labels'));
    ...
    describe('Data array', function () {
      ...
      beforeEach(function () {
        inject(function (d3, Private) {
          dataArray = Private(require('vislib/components/labels/data_array'));
    ...
    describe('Unique labels', function () {
      ...
      beforeEach(function () {
        inject(function (d3, Private) {
          uniqLabels = Private(require('vislib/components/labels/uniq_labels'));
    ...
    describe('Get series', function () {
      ...
      beforeEach(function () {
        inject(function (d3, Private) {
          getSeries = Private(require('vislib/components/labels/flatten_series'));
