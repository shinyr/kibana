  ...
  describe('Vislib Color Module Test Suite', function () {
    ...
    describe('Color (main)', function () {
      ...
      beforeEach(function () {
        inject(function (d3, Private) {
          seedColors = Private(require('vislib/components/color/seed_colors'));
          getColors = Private(require('vislib/components/color/color'));
          color = getColors(arr);
        });
      });
    ...
    describe('Color Palette', function () {
      ...
      beforeEach(function () {
        inject(function (d3, Private) {
          seedColors = Private(require('vislib/components/color/seed_colors'));
          createColorPalette = Private(require('vislib/components/color/color_palette'));
