    ...
    describe('Column Chart', function () {
      ...
      beforeEach(function () {
        inject(function (d3, Private) {
          chartSplit = Private(require('vislib/lib/layout/splits/column_chart/chart_split'));
          chartTitleSplit = Private(require('vislib/lib/layout/splits/column_chart/chart_title_split'));
          xAxisSplit = Private(require('vislib/lib/layout/splits/column_chart/x_axis_split'));
          yAxisSplit = Private(require('vislib/lib/layout/splits/column_chart/y_axis_split'));
