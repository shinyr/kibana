  ...
  describe('AggTypesComponent', function () {
    ...
    describe('bucket aggs', function () {
      ...
      beforeEach(inject(function (Private) {
        bucketAggs = Private(require('agg_types/index')).byType.buckets;
        BucketAggType = Private(require('agg_types/buckets/_bucket_agg_type'));
      }));
    ...
    describe('metric aggs', function () {
      ...
      beforeEach(module('kibana'));
      beforeEach(inject(function (Private) {
        metricAggs = Private(require('agg_types/index')).byType.metrics;
        MetricAggType = Private(require('agg_types/metrics/_metric_agg_type'));
      }));
