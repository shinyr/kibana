define(function (require) {
  return ['AggParams class', function () {
    ...
    beforeEach(inject(function (Private) {
      AggParams = Private(require('agg_types/_agg_params'));
      BaseAggParam = Private(require('agg_types/param_types/base'));
      FieldAggParam = Private(require('agg_types/param_types/field'));
      OptionedAggParam = Private(require('agg_types/param_types/optioned'));
      RegexAggParam = Private(require('agg_types/param_types/regex'));
    }));
