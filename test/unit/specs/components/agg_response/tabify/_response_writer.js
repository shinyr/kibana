    ...
    function defineSetup(stubGetColumns) {
      ...
      beforeEach(inject(function ($injector) {
        ...
        if (stubGetColumns) {
          ...
          Private.stub(require('agg_response/tabify/_get_columns'), getColumns);
        }

        ResponseWriter = Private(require('agg_response/tabify/_response_writer'));
        TableGroup = Private(require('agg_response/tabify/_table_group'));
        Buckets = Private(require('agg_response/tabify/_buckets'));
